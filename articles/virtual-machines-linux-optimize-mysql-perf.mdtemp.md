...
There are many factors that impact MySQL performance on Azure, both in virtual hardware selection and software configuration. You can always utilize the MySQL community for general performance optimization advice: 1. Search on performance at [MYSQL official site](http://mysql.com)  2. Consult the [MYSQL forums](http://forums.mysql.com/list.php?24). This article focuses on optimizing performance through storage, system, and database configurations.
